                ...
                <DialogContent >
                    <DialogContentText>
                        <form className={classes.form} noValidate={true} autoComplete="on">
                            <TextField id="dialog-push-message" name="dialog-push-message" label="Message" value={message.message} margin="normal" variant="outlined" onChange={change} />
                        </form>
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
                    <Button name="create-dialog-cancel" variant={"outlined"} onClick={() => props.close("Push-message")}>
                        Cancel
                    </Button>
                    <Button className={classes.button} variant="contained" color="primary" autoFocus={true} onClick={() => props.submit("Push-message")}>
                        Confirm
                    </Button>
                </DialogActions>
            </Dialog>
